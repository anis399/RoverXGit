...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CPU_CTRL_XMC1" URI="http://resources/4.0.12/app/CPU_CTRL_XMC1/0" description="Defines the number of bits assigned to preemption priority." version="4.0.12" minDaveVersion="4.0.0" instanceLabel="CPU_CTRL_XMC1_0" appLabel="">
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../SPI_MASTER/v4_3_30/SPI_MASTER_0.app#//@requiredApps.1"/>
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../SPI_MASTER/v4_3_30/SPI_MASTER_1.app#//@requiredApps.1"/>
  ...
  <hwResources name="bootmode_pin0" URI="http://resources/4.0.12/app/CPU_CTRL_XMC1/0/hwres_bootmode0" resourceGroupUri="" required="false" mResGrpUri="port/p/4/pad/6"/>
  <hwResources name="bootmode_pin1" URI="http://resources/4.0.12/app/CPU_CTRL_XMC1/0/hwres_bootmode1" resourceGroupUri="" required="false" mResGrpUri="port/p/4/pad/7"/>
